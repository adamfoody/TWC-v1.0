...
const CartItem = ({ item, onUpdateCartQty, onRemoveFromCart }) => {
	...
	return (
		...
		<Typography component="p" variant="h6" padding="20px">
				...
				<Typography padding ="20px" component="p" variant="h6" >
				...
				<Box className ="gapCart" padding = "20px">
		...
		<Typography padding="10px" padding="20px" fontWeight ={600}  >
			Total Cost 
				</Typography>
