  ...
  return (
    <AppBar style={{ background: "#673ab7" }}  position="static">
       ...
       */}
          ...
          <ShoppingCartTwoToneIcon   onClick={()=>handleMenuClick('/navcart')} style={{ fontSize: "6vh", color:'#FFFFFF' }}/>
          </Grid>
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              ...
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                ...
                <AccountCircleTwoToneIcon  style={{ fontSize: "6vh", color:'#FFFFFF' }}/>
          ...
          {isAuthenticated && (
            ...
            {user.email === "adamfoodywork@gmail.com" &&
                <MenuItem onClick={()=>handleMenuClick('/external-api')} > 
                <Typography color='#673ab7'  textAlign="center"> Admin </Typography> </MenuItem> 
                }    
                </>
                     )}
              ...
              color='#673ab7'
               ...
               {/**  {user.email === "adam@cybersmart.co.uk" && (
                <MenuItem> 
                <Typography 
                color='#673ab7'
                   onClick ={()=> logout()}
